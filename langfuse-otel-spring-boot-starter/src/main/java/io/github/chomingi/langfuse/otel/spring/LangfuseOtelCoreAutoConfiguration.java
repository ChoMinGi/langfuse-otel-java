...
public class LangfuseOtelCoreAutoConfiguration {

    private static final Logger log = LoggerFactory.getLogger(LangfuseOtelCoreAutoConfiguration.class);
    ...
    @ConditionalOnMissingBean(LangfuseOtel.class)
